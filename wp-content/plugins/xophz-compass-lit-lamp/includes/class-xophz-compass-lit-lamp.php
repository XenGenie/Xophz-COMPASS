...
class Xophz_Compass_Lit_Lamp {
	...
	public function __construct() {
		if ( defined( 'XOPHZ_COMPASS_LIT_LAMP_VERSION' ) ) {
			$this->version = XOPHZ_COMPASS_LIT_LAMP_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'xophz-compass-lit-lamp';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-xophz-compass-lit-lamp-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-xophz-compass-lit-lamp-i18n.php';
		...
		$this->loader = new Xophz_Compass_Lit_Lamp_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new Xophz_Compass_Lit_Lamp_i18n();
