...
const Billboard = defineAsyncComponent(() => import("./components/billboard/billboard.vue"));
const NavDrawer = defineAsyncComponent(
  () => import("./components/routes-navigation-drawer/routes-navigation-drawer.vue")
);
const AnimatedNumber = defineAsyncComponent(
  () => import("./components/animated-number/animated-number.vue")
);
