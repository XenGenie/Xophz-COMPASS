...
class Xophz_Compass_Quests {
    ...
    $this->loader->add_action( 'wp_ajax_people_primary_information', $plugin_admin, 'peoplePrimaryInformation' );
    $this->loader->add_action( 'wp_ajax_get_all_people', $plugin_admin, 'getAllPeople' );
	}
